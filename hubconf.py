...
def deeplabv3plus_resnet50(pretrained=False,progress=True,map_location=None,**kwargs):
  ...
  if pretrained:
    ...
    model.load_state_dict(torch.hub.load_state_dict_from_url(checkpoint,progress=progress,map_location=map_location)["model_state"])
  return model
  
def deeplabv3_resnet50(pretrained=False,progress=True,map_location=None,**kwargs):
...
def deeplabv3_resnet101(pretrained=False,progress=True,map_location=None,**kwargs):
...
def deeplabv3plus_resnet101(pretrained=False,progress=True,map_location=None,**kwargs):
...
def deeplabv3_mobilenet(pretrained=False,progress=True,map_location=None,**kwargs):
...
def deeplabv3plus_mobilenet(pretrained=False,progress=True,map_location=None,**kwargs):
